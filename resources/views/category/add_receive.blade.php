...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item"><a href="{{ route('category.receiveIndex') }}">Receive Category</a></li>
    <li class="breadcrumb-item active" aria-current="page">Create New Receive Category</li>
  </ol>
</nav>
<div class="container">
